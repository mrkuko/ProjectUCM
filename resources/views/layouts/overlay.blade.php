...
{{--                    active="request()->is('login')--}}
                    <x-sidebar-li :active="true" href='/' viewBox="0 0 22 21" class="m-0">
                        <x-slot:header>
                            Dashboard
                        </x-slot:header>
                        <x-slot:path>
                    ...
                    <!-- Stock -->
                    <x-sidebar-li href="#" viewBox="0 0 18 18" class="m-0">
                    ...
                    <!-- Logistics -->
                    <x-sidebar-li href="#" viewBox="0 0 20 20" class="m-0">
                    ...
                    <!-- Employees -->
                    <x-sidebar-li href="#" viewBox="0 0 20 18" class="m-0">
                    ...
                    <!-- Products -->
                    <x-sidebar-li href="#" viewBox="0 0 18 20" class="m-0">
                        <x-slot:header>Products</x-slot:header>
                        <x-slot:path>
                            <path d="M17 5.923A1 1 0 0 0 16 5h-3V4a4 4 0 1 0-8 0v1H2a1 1 0 0 0-1 .923L.086 17.846A2 2 0 0 0 2.08 20h13.84a2 2 0 0 0 1.994-2.153L17 5.923ZM7 9a1 1 0 0 1-2 0V7h2v2Zm0-5a2 2 0 1 1 4 0v1H7V4Zm6 5a1 1 0 1 1-2 0V7h2v2Z"/>                        </x-slot:path>
                    </x-sidebar-li>
                </ul>
            </div>
        </aside>
